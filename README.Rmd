...
The dependency package `fgsea` is a bioconductor package which seems to require compilation to install, so if prompted you should install that with compilation.
